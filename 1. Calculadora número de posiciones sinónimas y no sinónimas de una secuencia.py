...
print('Bienvenido a la calculadora de número de posiciones sinónimas y no sinónimas de una secuencia.')
seq_input = input('Introduce la secuencia: ')
posiciones_seq(seq_input)
